...
A: Ithought I'll get a scatter plot and 3 lines. both will have the color indecating the drive type of the car. That's actually what happened. I didn't know what (se = FALSE) will do. It removes the standard error around the line.
```{r}
...
A: it shows and hides the legend for color, size, alpha, atc. I have no idea why the author used it in the begining of the book.<br />

4<br />
Q: What does the se argument to geom_smooth() do? <br />
A: Setting it to false will hide the standard error visualisation around the line otherwise shown<br />
5 <br />
...
A: They are the same type of plot using a diffrent stat. geom_bar defaults to hight of the box representing the number of cases. in geom_col we need to provide another variable from the data set that will be represented as the bar hight.
